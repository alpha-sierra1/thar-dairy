      ...
      >
        ...
        >
          ...
          >
            ...
            <h3 className='text-lg font-semibold text-white'>Quality Ingredients</h3>
          ...
          >
            ...
            <h3 className='text-lg font-semibold text-white'>Traditional Methods</h3>
            <p className='mt-2 text-sm text-gray-200'>
          ...
          >
            ...
            <h3 className='text-lg font-semibold text-white'>Sustainable Sourcing</h3>
            <p className='mt-2 text-sm text-gray-200'>
