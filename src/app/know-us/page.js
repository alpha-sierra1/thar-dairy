      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:mx-0'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            At Thar Dairy, my father and I saw the widespread use of adulterated ghee around us, and
            we knew we could make a difference. We decided to take matters into our own hands and
            create something better. That is how Bilona Ghee was born. A promise from our family to
            yours, delivering the pure, authentic ghee that you truly deserve.
          </p>
        </div>
        <div className='mx-auto mt-12 max-w-2xl lg:mx-0 lg:max-w-none'>
          <dl className='mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4'>
            {stats.map((stat) => (
              ...
              >
                <dd className='text-4xl font-bold leading-9 tracking-tight'>{stat.value}</dd>
                <dt className='mt-2 text-lg leading-7 text-gray-300'>{stat.name}</dt>
              </div>
            ))}
          </dl>
        </div>
